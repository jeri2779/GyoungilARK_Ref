...
public static class WindFaceCalc
{
    ...
    public static Dictionary<Vector2Int, List<Tile>> BuildFaces(Map board)
    {
    ...
    private static List<Tile> ReadColumn(Map board, int column, int minRow, int maxRow)
    {
        List<Tile> face = new();
    ...
    private static List<Tile> ReadRow(Map board, int row, int minColumn, int maxColumn)
    {
        List<Tile> face = new();
    ...
    private static void KeepSpecial(Map board, List<Tile> face, Vector2Int cell)
    {
